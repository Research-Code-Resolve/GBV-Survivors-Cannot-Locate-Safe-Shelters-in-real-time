...
export default function AdminSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    // The access code is checked inside the staff-signup Edge Function
    // using the service_role key -- never here in the browser. This
    // call just forwards what the user typed.
    ...
    // Account created -- sign them in right away.
      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p style={{ color: "#333333" }} className="text-sm mt-1 text-center">
            Requires a valid staff access code
          </p>
        </div>
        ...
        >
          <div>
            ...
            <input
              ...
              placeholder="Given to you by your team admin"
